...
public class EmployeeLoginController implements HttpHandler {
    ...
    private void postRequest(HttpExchange exchange) throws IOException {
        ...
        // employeeService.EmployeeRegistration(textBuilder.toString(), newEmployee);
        
        
       

        OutputStream os = exchange.getResponseBody();
        os.write(loginValue.getBytes());
        os.close();
    }
